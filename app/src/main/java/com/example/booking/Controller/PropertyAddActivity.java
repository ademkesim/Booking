...
public class PropertyAddActivity extends AppCompatActivity {
    Spinner spinnerCountry,spinnerCity, spinnerType, spinnerPriceType;
    TextView txtTittle, txtPrice, txtNumberRoom, txtNumberFloor, txtAddress2, txtOtherFeatures;
    ImageView imageView;
    Bitmap bitmapImage;
    ...
    void addProperty(){
        ...
        Control(textViews,propertyManager,property);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == 2 && data != null && resultCode== RESULT_OK){
            ...
            try {
                ...
                bitmapImage = Bitmap.createScaledBitmap(bitmapImage, 400, 400, false);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNumberRoom = findViewById(R.id.txtNumberRoom);
        txtNumberFloor = findViewById(R.id.txtNumberRoom);
        txtAddress2 = findViewById(R.id.txtAddress2);
        txtOtherFeatures = findViewById(R.id.txtOtherFeatures);
        imageView=findViewById(R.id.imgProperty);
